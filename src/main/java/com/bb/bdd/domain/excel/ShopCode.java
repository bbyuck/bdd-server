...
public enum ShopCode {
    COUPANG("쿠팡", 1, 0, DownloadCode.COUPANG_CNP, DownloadCode.COUPANG_TRACKING_NUMBER_INPUT, "수취인이름", "수취인전화번호"),
    NAVER("네이버", 1, 1, DownloadCode.NAVER_CNP, DownloadCode.NAVER_TRACKING_NUMBER_INPUT, "수취인명", "수취인연락처1");
